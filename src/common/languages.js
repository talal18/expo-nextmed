export const localizedStrings = {
  ...
  fr: {
    ...
    startEndDate: "date de début et de fin",
  ...
  es: {
    ...
    startEndDate: "fecha de inicio y finalización",
    notesLabel: "notas",
  ...
  ar: {
    ...
    typeLabels: {
      ...
      powderLabel: "مسحوق",
      sparyLabel: "بخاخ",
      suppositoriesLabel: "تحميلة",
      trochesLabel: "قرص"
    },
    addTimesLabel: "إضافة مواعيد",
    dosageLabel: "جرعة",
    frequencyLabel: "التكرر",
    frequencyMenuLabels: {
      dailyLabel: "يومي",
      weeklyLabel: "أسبوعي",
      monthlyLabel: "شهريا",
